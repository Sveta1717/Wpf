...
Миграции создаются командой в консоли менеджера пакетов (РМ) (tools -> NuGets -> Consol)
PM> Add-Migration  ИмяМиграции (ADD-Migration initial)
